...
const About = () => {
  ...
  const phrases = [
    <div className="relative w-full flex justify-center mt-12 mb-16">
      <blockquote className="bg-zinc-900 bg-opacity-70 p-8 md:p-12 rounded-2xl shadow-xl max-w-5xl w-full text-center">
        <p className="text-2xl sm:text-xl md:text-2xl lg:text-3xl xl:text-3xl 2xl:text-4xl italic text-gray-200 leading-relaxed">
  ...
  const authorDescription = (
    <div className="text-lg sm:text-xl lg:text-2xl leading-relaxed space-y-6 text-left">
      <p>
  ...
  return (
    <div className="px-6 py-12 sm:px-12 lg:px-24">
      <div className="flex flex-col items-start justify-center mx-auto w-full max-w-4xl">
        {/* Page heading */}
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-8 text-center sm:text-left">
